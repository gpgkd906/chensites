...
class riyou {
	...
	static public function content($site) {
		...
		wp_update_post(array(
				"ID" => 1,
				"post_title" => "コンセプト",
				"post_content" => '<h3>[plagesubsite key=キャッチコピー]</h3><img src="' . App::$site . '/wp-content/plugins/penseur/engine/resource/riyou/upload/img01.jpg" /><div class="concept">[plagesubsite key=ボディコピー displayer=App::nl2p]</div>'));
	...
	static public function options($site) {
		...
		$config = array (
			'logo' => App::$site . '/wp-content/plugins/penseur/engine/resource/riyou/upload/plagePcLogo.gif',
			'contactAddress' => $site["郵便番号"] . $site["住所"],
			'contactTel' => $site["電話"],
			'contactTime' => $site["営業時間"],
			'productHeading' => '',
			"product1Img" => App::$site . "/wp-content/plugins/penseur/engine/resource/riyou/banners/banner_m1.png",
			"product1Name" =>"",
			"product1Link" =>"",
			"product2Img" => App::$site . "/wp-content/plugins/penseur/engine/resource/riyou/banners/banner_m2.png",
			"product2Name" =>"",
			"product2Link" =>"",
			"product3Img" => App::$site . "/wp-content/plugins/penseur/engine/resource/riyou/banners/banner_m3.png",
			"product3Name" =>"",
			"product3Link" =>"",
			"banner1Img" => App::$site . "/wp-content/plugins/penseur/engine/resource/riyou/upload/btn_menu.jpg",
			"banner1Name" =>"",
			"banner1Link" => $menu_post->guid,
			"banner2Img" => App::$site . "/wp-content/plugins/penseur/engine/resource/riyou/upload/btn_recruit.jpg",
			"banner2Name" =>"",
		...
		//top_image
		$top_image = App::$site . "/wp-content/plugins/penseur/engine/resource/riyou/upload/img_top.jpg";
